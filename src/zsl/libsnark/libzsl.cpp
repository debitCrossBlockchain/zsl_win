...
bool LibZsl::zsl_verify_shielding(
	void* proof_ptr,
	void* send_nf_ptr,
	void* cm_ptr,
	uint64_t value
...
bool LibZsl::zsl_verify_unshielding(
	void* proof_ptr,
	void* spend_nf_ptr,
	void* rt_ptr,
	uint64_t value
...
void LibZsl::zsl_prove_unshielding(
	void* rho_ptr,
	void* pk_ptr,
	uint64_t value,
...
void LibZsl::zsl_prove_shielding(
	void* rho_ptr,
	void* pk_ptr,
	uint64_t value,
	void* output_proof_ptr
...
bool LibZsl::zsl_verify_transfer(
	void* proof_ptr,
	void* anchor_ptr,
	void* spend_nf_ptr_1,
	void* spend_nf_ptr_2,
...
void LibZsl::zsl_prove_transfer(
	void* output_proof_ptr,
...
void LibZsl::zsl_paramgen_transfer()
{
	protoboard<FieldT> pb;
	TransferCircuit<FieldT> g(pb);
	g.generate_r1cs_constraints();
...
void LibZsl::zsl_paramgen_shielding()
{
	protoboard<FieldT> pb;
	ShieldingCircuit<FieldT> g(pb);
	g.generate_r1cs_constraints();
...
void LibZsl::zsl_paramgen_unshielding()
{
	protoboard<FieldT> pb;
	UnshieldingCircuit<FieldT> g(pb);
	g.generate_r1cs_constraints();
