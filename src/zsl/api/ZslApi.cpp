...
#include<libzsl.h>
ZslApi::ZslApi(){
	libzsl = make_shared<LibZsl>();
	ZslInitialize();
}

void ZslApi::ZslInitialize() {
	libzsl->zsl_initialize();
}
...
void ZslApi::ZslProveShielding(
	...
	libzsl->zsl_prove_shielding(e_rho, e_pk, value, proof_str);
...
bool ZslApi::ZslVerifyShielding(
	...
	return libzsl->zsl_verify_shielding(e_proof,e_send_nf,e_cm,value);
}
...
void ZslApi::ZslProveUnshielding(
	...
	libzsl->zsl_prove_unshielding(e_rho, e_sk, value,tree_position,auth_path, proof);
...
bool ZslApi::ZslVerifyUnshielding(
	...
	return libzsl->zsl_verify_unshielding(e_proof, e_spend_nf, e_rt, value);
}
...
bool ZslApi::ZslVerifyTransfer(
	...
	return libzsl->zsl_verify_transfer(proof_ptr,anchor_ptr,spend_nf_ptr_1,spend_nf_ptr_2,send_nf_ptr_1,send_nf_ptr_2,cm_ptr_1,cm_ptr_2);
}

void ZslApi::ZslParamgenShielding(){
	libzsl->zsl_paramgen_shielding();
}

void ZslApi::ZslParamgenUnshielding(){
	libzsl->zsl_paramgen_unshielding();
}

void ZslApi::ZslParamgenTransfer(){
	libzsl->zsl_paramgen_transfer();
}